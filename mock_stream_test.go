...
//
//	mockgen -typed -build_flags=-tags=gomock -package masque -self_package github.com/quic-go/masque-go -destination mock_stream_test.go github.com/quic-go/quic-go/http3 Stream
//

// Package masque is a generated GoMock package.
package masque
